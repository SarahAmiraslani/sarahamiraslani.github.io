...
The research project employs machine learning techniques to analyze the physical characteristics of solar wind, trace its origins in the solar corona, and improve the prediction of heliophysical phenomena. By utilizing data from the Advanced Composition Explorer (ACE) spacecraft sensors and indices from the Heliospheric Current Sheet (HCS), our goal is to enhance the understanding of solar wind properties and their coronal sources. This deeper insight aims to improve the prediction of future sunspots on the Sun.
